...
This project is indexed by GitNexus as **ArchiteX** (526 symbols, 715 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/ArchiteX/process/{processName}` — trace the full execution flow step by step
